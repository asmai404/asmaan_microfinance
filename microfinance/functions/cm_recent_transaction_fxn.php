<?php
include '../action/cm_get_recent_transactions.php';
...
function display_recent_transactions() {
    ...
    if ($names !== false) {
        ...
        if (!empty($names)) {
            ...
            echo "<table>";
            echo "<tr style='color:#0056b3;'><th>Client name</th><th>Client email</th><th>Loan amount</th><th>Outstanding balance</th><th>Total amount repaid</th><th>Current amount repaid</th><th>Transaction date</th><th>Status</th></tr>";         
