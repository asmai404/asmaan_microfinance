...
<body>
    <div class="container">
        ...
        <p class="register-link"><span style="color: red; font-family: Times New Roman, sans-serif;">Only our clients are eligible to client page</span> | <a href="home_view_client.php" style="color:green; text-decoration: underline; font-size:18px;">Back <i class='bx bx-log-out'></i></a></p>
    </div>
