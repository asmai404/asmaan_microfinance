...
if ($userRoleID !== false) {
	...
	$_SESSION['assign_error'] = "Only standard users can apply for loan";
        ...
        header("Location: home_view_client.php");
        die();
    }
} else {
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="../action/loan_application_form_action_client.php" method="post" onsubmit="return validateForm()">
                            <fieldset>
                        ...
                        <p class="form-group" style="text-align: center; color:red; text-decoration: underline; font-size:18px;">
                            <a href="home_view_client.php">Back <i class='bx bx-log-out'></i></a>
                        </p>            
                    </div>
                </div>
            </div>
