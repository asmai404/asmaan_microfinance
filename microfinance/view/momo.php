<?php
include("../settings/momoHeader.php");
...
<head>
    ...
    <title>MOMO Transaction - Asmaan MicroFinance</title>
...
<body>
    ...
    <h2>Momo Account</h2>
    <form id="add-transaction-form" action="../action/momo_action.php" method="post">
        <label for="transaction-type">Transaction Type:</label>
        <select id="type" name="type" required>
            <option value="repayment">MOMO</option>
        </select>
        <br><br>
        ...
        <button type="submit" name="submit" style="font-family: Times New Roman, sans-serif;">SEND</button>
    </form>
