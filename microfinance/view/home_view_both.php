...
<body>
    <nav>
        <ul style="text-align:center;">
            <li><a href="client_page_both.php" style="color:#0056b3; text-decoration: underline; font-size:21px;">Client Page</a></li>
            <li><a href="about_us_both.php" style="color:#0056b3; text-decoration: underline; font-size:21px;">About Us</a></li>
            <li><a href="contact_us_both.php" style="color:#0056b3; text-decoration: underline; font-size:21px;">Contact Us</a></li>
    ...
    <section class="hero">
	    ...
	    <br><br>
	    <a href="loan_application_form_both.php" class="btn">Apply Now</a>
        </div>
    </section>
