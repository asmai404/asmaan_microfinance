...
include ("../functions/recent_transaction_fxn.php");

// Check user role
$userRoleID = getUserRoleID();
if ($userRoleID !== false) {
    if ($userRoleID != 1) {
        $_SESSION['assign_error'] = "Transaction Management: Only super admin can access";
...
<body>
    <div class="panel panel-default">
        <div class="full-screen-container bg-dark text-white">
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <a class="btn btn-info" href="all_transactions.php" style="color:blue-black">All Transactions</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <h2 style="text-align:center; font-weight: bold; font-family:Times New Roman, san-serif; text-decoration: underline;">Recent Transactions</h2>
