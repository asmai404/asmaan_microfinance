...
include '../functions/contact_us_fxn.php';
...
<head>
    ...
    <title>Customers Messages||Reports - Asmaan MicroFinance</title>
...
<body>
    <h1 style="font-family:Times New Roman, san-serif; font-size:30px; text-align:center; text-decoration: underline;">Customers' Messages And Reports</h1>
