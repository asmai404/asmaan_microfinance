...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['email'])) {
        ...
        // Retrieve user's balance and PIN from bank_account
        $query = "SELECT * FROM bank_account WHERE email = '$userEmail'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($pin === $pinStored) {
                ...
                if ($currentBalance >= $amount) {
                    ...
                    $updateQuery = "UPDATE bank_account SET balance = $newBalance WHERE email = '$userEmail'";
                    ...
                    if (mysqli_num_rows($checkTransactionResult) > 0) {
                        ...
                        $updateTransactionQuery = "UPDATE transaction_mgt 
                                                   SET amount_repaid = $amount, 
                                                       ...
                                                       transaction_method = 'Bank-Account',
                                                       sid = 1 
                        ...
                        $insertTransactionQuery = "INSERT INTO transaction_mgt (email, sid, amount_repaid, outstanding_balance, total_amount_repaid, transaction_date, transaction_method)
                                                   VALUES ('$userEmail', 1, $amount, $initialOutstandingBalance, $amount, NOW(), 'Bank-Account')";
                    ...
                    assign_error("Insufficient balance in your Bank-Account.");
