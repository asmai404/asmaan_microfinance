...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($phone_count > 0) {
        ...
        header("Location: ../pop_up_messages/display_duplicate_loan_phone_alert_client.php");
        exit();
    }
    ...
    if ($email_count > 0) {
        // Registration successful, redirect to registration success page
        header("Location: ../pop_up_messages/display_duplicate_loan_email_alert_client.php");
        exit();
    } 
    ...
    if ($stmt->execute()) {
        // Registration successful, redirect to registration success page
        header("Location: ../pop_up_messages/display_successful_loan_application_client.php");
        exit();
    } else {
