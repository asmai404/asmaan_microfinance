...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email_count > 0) {
        ...
        header("Location: ../pop_up_messages/display_duplicate_contact_us_email_alert_client.php");
        exit();
    } 
    ...
    if ($stmt->execute()) {
        // Registration successful, redirect to registration success page
        header("Location: ../pop_up_messages/display_successful_contact_us_form_submission_client.php");
        exit();
    } else {
